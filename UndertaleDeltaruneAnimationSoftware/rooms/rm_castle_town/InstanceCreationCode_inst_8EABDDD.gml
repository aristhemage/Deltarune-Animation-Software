function cutscene(){
	with(obj_cutscene_master){
		var actions = [
				...
				action_display_text(["Woah I cant beleive that over there is the true identiy of the roaring knight!"]),
