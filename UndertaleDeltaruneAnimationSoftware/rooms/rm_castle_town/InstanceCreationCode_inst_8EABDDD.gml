function cutscene(){
	with(obj_cutscene_master){
		var actions = [
				...
				action_move_actor_direct_checkpoint("Susie","start",2),
				...
				action_create_actor_checkpoint("Ralsei","ralstart",spr_ralsei_walk_down, spr_ralsei_walk_down,spr_ralsei_walk_right,spr_ralsei_walk_up,spr_ralsei_walk_left,true),
				action_move_actor_direct_checkpoint("Ralsei","ral",2),
				...
				action_move_actor_nondirect_checkpoint("Ralsei","ral2",2,PREFER.HORZ),
				action_fade_actor("Ralsei",0.05),
				action_play_sound(snd_doorclose),
				action_wait_time(1.5),
				action_play_sound(snd_dooropen),
				action_create_actor_checkpoint("Ralsei","ral2",spr_ralsei_dress, spr_ralsei_dress,spr_ralsei_walk_right,spr_ralsei_walk_up,spr_ralsei_walk_left,true),
				action_move_actor_nondirect_checkpoint("Ralsei","ral3",2,PREFER.VERT),
				action_actor_set_autowalk("Susie",true),
				action_actor_show_exclamation("Susie"),
				action_move_actor_nondirect_checkpoint("Susie","sus", 4, PREFER.VERT),
