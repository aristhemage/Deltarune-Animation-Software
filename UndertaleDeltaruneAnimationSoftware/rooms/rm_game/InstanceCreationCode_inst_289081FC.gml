function cutscene(){
	with(obj_cutscene_master){
		var actions = [
				...
				action_display_text(["Woah I cant beleive that over there is the true identiy of the roaring knight!"],snd_text_susie,1,120,true,spr_face_susie,8,2,false),
